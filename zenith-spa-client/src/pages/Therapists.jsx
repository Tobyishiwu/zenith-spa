      ...
      <section className="relative flex min-h-[55vh] items-end overflow-hidden bg-stone-900 pb-20 pt-40">
        ...
        <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <p className="mt-5 max-w-xl text-base leading-8 text-stone-300">
            Every therapist is professionally trained and carefully selected to
            deliver a five-star spa experience wherever you are.
          </p>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-6 py-20 lg:px-8">
        ...
        {!loading && filtered.length === 0 && (
          <div className="flex flex-col items-center justify-center py-24 text-center">
            ...
            <h3 className="mt-5 text-xl font-semibold text-stone-700">
              No therapists found
            </h3>
          ...
          <>
            <div className="grid gap-8 md:grid-cols-2 xl:grid-cols-3">
              {filtered.map((therapist) => (
                <TherapistCard
                  key={therapist._id || therapist.slug}
                  therapist={therapist}
                />
              ))}
            </div>
      ...
      <section className="bg-stone-900 py-20">
        <div className="mx-auto max-w-3xl px-6 text-center">
          ...
          <p className="mx-auto mt-4 max-w-md text-sm leading-7 text-stone-400">
            Browse profiles, read specializations, and book the therapist that
            fits your needs.
          </p>
          ...
          <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
            <Link
              to="/booking"
              className="inline-flex items-center gap-2 rounded-2xl bg-teal-600 px-8 py-4 text-sm font-semibold text-white transition hover:bg-teal-700"
            >
              Book Appointment
            ...
            <Link
              to="/services"
              className="rounded-2xl border border-white/20 bg-white/10 px-8 py-4 text-sm font-semibold text-white transition hover:bg-white/20"
            >
              Browse Treatments
            </Link>
          </div>
